...
class LoadFactOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        rendered_truncate_sql = LoadFactOperator.truncate_sql.format(
        ...
        rendered_insert_sql = LoadFactOperator.insert_sql.format(destination_table=self.destination_table,\
